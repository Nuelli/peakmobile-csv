...
const TELCO_PREFIXES = {
  safaricom: ['110', '111', '112', '113', '114', '115', '116', '117', '118', '119', '700', '701', '702', '703', '704', '705', '706', '707', '708', '709', '710', '711', '712', '713', '714', '715', '716', '717', '718', '719', '720', '721', '722', '723', '724', '725', '726', '727', '728', '729', '740', '741', '742', '743', '745', '748', '757', '758', '759', '768', '769', '790', '791', '792', '793', '794', '795', '796', '797', '798', '799'],
  airtel: ['100', '101', '102', '103', '104', '105', '106', '107', '108', '109', '730', '731', '732', '733', '734', '735', '736', '737', '738', '739', '750', '751', '752', '753', '754', '755', '756', '762', '780', '781', '782', '783', '784', '785', '786', '787', '788', '789'],
  telkom: ['770', '771', '772', '773', '774', '775', '776', '777', '778', '779'],
  equitel: ['763', '764', '765', '766'],
  faiba: ['747'],
  'homelands-media': ['744'],
  'mobile-pay': ['760'],
  eferio: ['761'],
...
export const detectTelco = (phoneNumber) => {
  ...
  // Debug logging
  console.log('Telco Detection Debug:', {
  ...
  for (const [telco, prefixes] of Object.entries(TELCO_PREFIXES)) {
    if (prefixes.includes(prefix)) {
      console.log('Telco found:', telco);
      return telco.charAt(0).toUpperCase() + telco.slice(1);
    }
  }
  
  console.log('No telco found for prefix:', prefix);
  return null;
};
